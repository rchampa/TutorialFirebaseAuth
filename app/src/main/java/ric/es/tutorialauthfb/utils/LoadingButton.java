...
import ric.es.tutorialauthfb.R;
...
public class LoadingButton extends View {
    ...
    private void init(Context context,AttributeSet attrs){
        ...
        if(attrs != null){
            ...
            mColorPrimary = ta.getInt(R.styleable.LoadingButton_btnColorBL,defaultColor);
            String text = ta.getString(R.styleable.LoadingButton_textBL);
            mText = text == null ? "" : text;
            mTextColor = ta.getColor(R.styleable.LoadingButton_textColorBL,Color.WHITE);
            resetAfterFailed = ta.getBoolean(R.styleable.LoadingButton_resetAfterFailedBL,true);
            mRippleColor = ta.getColor(R.styleable.LoadingButton_rippleColorBL,Color.BLACK);
            ta.recycle();
        }
    ...
    public void loadingSuccessful(){
        ...
        //workarround to avoid mLoadingAnimator.isRunning() returning false
